...
export default class SfAiAgent extends LightningElement {
    ...
    quickActions = [
        ...
        },
        {
            ...
            prompt: 'Describe the Account object — all fields with data types and child relationships'
        },
        {
            ...
            prompt: 'Fetch child Contact records for a given Account using a relationship SOQL subquery'
        },
        {
